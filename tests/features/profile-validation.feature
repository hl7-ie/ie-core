...
Feature: IE Core Profile Validation
  ...
  Scenario: IE Core Patient example validates against the profile
    ...
    And the resource should have a meta.profile containing "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/StructureDefinition/ie-core-patient"
  ...
  Scenario: IE Core Patient GMS identifier format is valid
    Given I have the example resource "Patient-ie-core-patient-example.json"
    When I extract identifiers with system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/gms"
