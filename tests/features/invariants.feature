...
Feature: Profile Invariant Validation
  ...
  Scenario Outline: Valid IHI numbers are accepted
    Given a Patient identifier with system "https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/sid/ihi"
  ...
  Scenario Outline: Valid GMS numbers are accepted
    Given a Patient identifier with system "https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/sid/gms"
