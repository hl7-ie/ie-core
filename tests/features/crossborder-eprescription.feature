...
Feature: Cross-Border ePrescription Workflow — Seán Murphy (IE) across EU
  ...
  Scenario: Seán Murphy patient resource has required Irish identifiers
    ...
    And one identifier should use system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/ihi"
    And one identifier should use system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/pps"
  ...
  Scenario: Seán Murphy PPS identifier has correct format
    Given I have the example resource "Patient-ie-core-patient-sean-murphy.json"
    When I extract identifiers with system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/pps"
  ...
  Scenario: GP Dr. Aoife O'Brien has IMC identifier
    ...
    And one identifier should use system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/imc"
  ...
  Scenario: Grafton Street Medical Practice has CRN identifier
    ...
    And one identifier should use system "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/crn"
