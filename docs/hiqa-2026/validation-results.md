...
| `Medication-ie-medication-dispensed-be-to-ie-neps.json` | PASS | 0 | 4 |
| `Medication-ie-medication-dispensed-de-lisinopril.json` | PASS | 0 | 4 |
| `Medication-ie-medication-dispensed-de-metformin.json` | PASS | 0 | 4 |
| `Medication-ie-medication-dispensed-fi-to-ie-neps.json` | PASS | 0 | 4 |
| `Medication-ie-medication-dispensed-lv-metformin.json` | PASS | 0 | 4 |
| `Medication-ie-medication-dispensed-pt-sertraline.json` | PASS | 0 | 4 |
...
| `MedicationRequest-ie-rx-be-atorvastatin-neps.json` | PASS | 0 | 4 |
| `MedicationRequest-ie-rx-fi-metformin-neps.json` | PASS | 0 | 4 |
