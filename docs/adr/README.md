...
|---|---|---|---|
| [ADR-001](ADR-001-hiqa-logical-models-and-mapping.md) | HIQA logical models and the mapping approach | Accepted | no |
| [ADR-002](ADR-002-context-specific-demographics.md) | Context-specific demographics and data minimisation | Accepted | **yes** |
| [ADR-003](ADR-003-eprescription-parents-signature-crossborder.md) | ePrescription/eDispensation parents, signature and cross-border flag | Accepted | **yes** |
