...
**Canonical URL**: `https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core`  
**Package**: `hl7.fhir.ie.core`  
**Version**: 0.1.1  
**FHIR Version**: R4 (4.0.1)  
**Status**: Draft (CI Build)

[![Build IE Core FHIR IG](https://github.com/nithinmohantk/ie-fhir-ig-core-draft/actions/workflows/build-ig.yml/badge.svg)](https://github.com/nithinmohantk/ie-fhir-ig-core-draft/actions/workflows/build-ig.yml)
...
- **Base URL:** `https://hl7-ie.github.io/ie-fhir-ig-core-draft` (GitHub Pages PoC)
...
```env
# Default: https://hl7-ie.github.io/ie-fhir-ig-core-draft (GitHub Pages PoC)
IE_CORE_BASE_URL=https://hl7-ie.github.io/ie-fhir-ig-core-draft
...
This IG is currently hosted at **`https://hl7-ie.github.io/ie-fhir-ig-core-draft/`** via GitHub Pages under the `hl7-ie` organization. This demonstrates how the IG can be built, maintained, and versioned using industry-standard DevOps practices.
