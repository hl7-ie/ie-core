...
* url = "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/TestScript/ie-core-testscript-patient-read"
...
* test[=].action[=].assert.expression = "meta.profile.where($this = 'https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/StructureDefinition/ie-core-patient').exists()"
* test[=].action[=].assert.warningOnly = false
...
* url = "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/TestScript/ie-core-testscript-patient-search"
...
* test[=].action[=].operation.accept = #json
* test[=].action[=].operation.encodeRequestUrl = true
* test[=].action[=].operation.params = "?identifier=https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/sid/ihi|210000000012345678"
...
* url = "https://hl7-ie.github.io/hl7-ie-fhir-draft-ig/fhir/ie/core/TestScript/ie-core-testscript-encounter-read"
