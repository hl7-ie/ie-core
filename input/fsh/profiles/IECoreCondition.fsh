...
* ^url = "http://hl7.hse.ie/fhir/ie/core/StructureDefinition/ie-core-condition-encounter-diagnosis"
* ^version = "0.1.0"
* ^status = #draft
...
* ^url = "http://hl7.hse.ie/fhir/ie/core/StructureDefinition/ie-core-condition-problems-health-concerns"
* ^version = "0.1.0"
* ^status = #draft
