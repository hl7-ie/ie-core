...
* value[x] only code
* value[x] 1..1
* valueCode from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-ethnicity (required)
...
* value[x] 1..1
* valueCodeableConcept from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-gender-identity (extensible)
...
* value[x] only Coding
* value[x] 1..1
* valueCoding from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-yes-no-unknown (required)
...
* value[x] only code
* value[x] 1..1
* valueCode from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-ihi-status (required)
...
* value[x] only code
* value[x] 1..1
* valueCode from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-ihi-record-status (required)
...
* extension[adherence].valueCodeableConcept from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-medication-adherence (extensible)
...
* extension[informationSource].valueCodeableConcept from http://hl7.hse.ie/fhir/ie/core/ValueSet/ie-core-information-source (extensible)
* value[x] 0..0
