...
* value[x] only code
* value[x] 1..1
* valueCode from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-ethnicity (required)
...
* value[x] 1..1
* valueCodeableConcept from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-gender-identity (extensible)
...
* value[x] only Coding
* value[x] 1..1
* valueCoding from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-yes-no-unknown (required)
...
* value[x] only code
* value[x] 1..1
* valueCode from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-ihi-status (required)
...
* value[x] only code
* value[x] 1..1
* valueCode from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-ihi-record-status (required)
...
* extension[adherence].valueCodeableConcept from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-medication-adherence (extensible)
...
* extension[informationSource].valueCodeableConcept from https://hl7-ie.github.io/ie-fhir-ig-core-draft/fhir/ie/core/ValueSet/ie-core-information-source (extensible)
* value[x] 0..0
