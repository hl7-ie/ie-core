...
* value[x] 1..1
* valueCodeableConcept from https://hl7-ie.github.io/ie-core/fhir/ie/core/ValueSet/ie-core-gender-identity (extensible)
...
* value[x] only code
* value[x] 1..1
* valueCode from https://hl7-ie.github.io/ie-core/fhir/ie/core/ValueSet/ie-core-ihi-status (required)
...
* value[x] only code
* value[x] 1..1
* valueCode from https://hl7-ie.github.io/ie-core/fhir/ie/core/ValueSet/ie-core-ihi-record-status (required)
...
* extension[adherence].valueCodeableConcept from https://hl7-ie.github.io/ie-core/fhir/ie/core/ValueSet/ie-core-medication-adherence (extensible)
